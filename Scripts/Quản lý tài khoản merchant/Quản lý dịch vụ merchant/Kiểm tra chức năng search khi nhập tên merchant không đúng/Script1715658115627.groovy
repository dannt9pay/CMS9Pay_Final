...
WebUI.sendKeys(findTestObject('Quản lý tài khoản merchant/Quản lý dịch vụ merchant/accountName'), 'dannt11222')

WebUI.click(findTestObject('Quản lý tài khoản merchant/Quản lý dịch vụ merchant/searchBtn'))

String textSearchIncorect = WebUI.getText(findTestObject('Quản lý tài khoản merchant/Quản lý dịch vụ merchant/textSearchIncorect'))

WebUI.verifyEqual(textSearchIncorect, "Không tìm thấy dữ liệu.")
