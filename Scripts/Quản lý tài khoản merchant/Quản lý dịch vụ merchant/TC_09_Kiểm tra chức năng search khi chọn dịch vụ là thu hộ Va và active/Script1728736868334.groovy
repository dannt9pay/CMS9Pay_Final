...
println("Số lượng phần tử: " + SttActives.size())

def expectedElementStt= 25;
def expectedElements = 24;

if (elements.size() == expectedElements && SttActives.size() == expectedElementStt) {
