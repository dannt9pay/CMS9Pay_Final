...
for (WebElement element : SttInactives) {
    // Lấy văn bản của phần tử
    String elementText = element.getText()
    
    // Kiểm tra xem văn bản có khớp với "Không hoạt động" hay không
    if (elementText == 'Không hoạt động') {
        println("Element text is correct: " + elementText)
    } else {
        println("Element text is incorrect: " + elementText)
    }
}
