...
//Assert.assertEquals(driver.findElement(By.xpath("//label[contains(text(),'Vui lòng nhập số tiền chuyển.')]")).getText(), "Vui lòng nhập số tiền chuyển.")
Assert.assertEquals(driver.findElement(By.xpath("//label[contains(text(),'Vui lòng chọn ví nhận.')]")).getText(), "Vui lòng chọn ví nhận.")