...
WebElement approveDps = driver.findElement(By.xpath(GlobalVariable.xpathButtonApprove))
js.executeScript("arguments[0].scrollIntoView(false);", approveDps);
approveDps.click()
Thread.sleep(1000)
driver.findElement(By.xpath(GlobalVariable.xpathCfBtn)).click()
driver.findElement(By.xpath(GlobalVariable.xpathBtnOk)).click()
//String loaiGiaodich = driver.findElement(By.xpath("//td[contains(text(),'Nạp tiền')]")).getText()
...
WebElement thuHoi = driver.findElement(By.xpath(GlobalVariable.xpathThuHoi))
js.executeScript("arguments[0].scrollIntoView(false);", thuHoi);
thuHoi.click()
driver.findElement(By.xpath("//input[@placeholder='Nội dung']")).sendKeys("Test")
