...
//Assert.assertEquals(driver.findElement(By.xpath(GlobalVariable.xpathAccountName1)).getText(), GlobalVariable.username)
...
Assert.assertEquals(driver.findElement(By.xpath(GlobalVariable.xpathLoiAmountLaChu)).getText(), "amount phải là chữ số.")

driver.findElement(By.xpath(GlobalVariable.xpathDepositTextbox)).clear()
driver.findElement(By.xpath(GlobalVariable.xpathDepositTextbox)).sendKeys("NGuyen tien dan")
driver.findElement(By.xpath(GlobalVariable.xpathButtonSubmit)).click()
