...
driver.findElement(By.xpath(GlobalVariable.xpathOptionNapTien)).click()
driver.findElement(By.xpath(GlobalVariable.xpathOptionHoanPhi)).click()
...
wait.until(ExpectedConditions.elementToBeClickable(By.xpath(GlobalVariable.xpathDuyetGDNap)))
WebElement startElement1 = driver.findElement(By.xpath(GlobalVariable.xpathDuyetGDNap))
js.executeScript("arguments[0].scrollIntoView(false);", driver.findElement(By.xpath(GlobalVariable.xpathDuyetGDNap)));
