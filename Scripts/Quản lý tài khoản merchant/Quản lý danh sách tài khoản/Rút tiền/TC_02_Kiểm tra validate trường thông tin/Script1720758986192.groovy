...
driver.findElement(By.xpath(GlobalVariable.xpathParentThuHo)).click()
driver.findElement(By.xpath(GlobalVariable.xpathBtnContinue)).click()
Assert.assertEquals(driver.findElement(By.xpath(GlobalVariable.xpathChonKiDoiSoat)).getText(), "Vui lòng chọn kỳ đối soát")
