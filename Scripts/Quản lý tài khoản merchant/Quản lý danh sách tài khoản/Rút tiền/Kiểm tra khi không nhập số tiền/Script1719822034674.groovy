...
Assert.assertEquals(wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[contains(text(),'Tham số không hợp lệ')]"))).getText(), "Tham số không hợp lệ")
